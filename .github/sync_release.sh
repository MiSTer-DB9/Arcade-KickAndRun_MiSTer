...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-KickAndRun_MiSTer.git"
CORE_NAME=(Arcade-KickAndRun)
...
UPSTREAM_CORE_NAME=(Arcade-KickAndRun)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-KickAndRun.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-KickAndRun.rbf)
